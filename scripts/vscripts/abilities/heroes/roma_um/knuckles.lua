...
LinkLuaModifier("modifier_Knuckles_Spit", "abilities/heroes/roma_um/knuckles", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_knuckles_spit_debuff", "abilities/heroes/roma_um/knuckles", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_heal_uganda_aura", "abilities/heroes/roma_um/knuckles", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_knuckles_crystal_maiden_aura", "abilities/heroes/roma_um/knuckles", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_knuckles_crystal_maiden", "abilities/heroes/roma_um/knuckles", LUA_MODIFIER_MOTION_NONE)
