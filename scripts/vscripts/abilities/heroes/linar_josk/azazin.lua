...
LinkLuaModifier("modifier_azazin_gayaura", "abilities/heroes/linar_josk/azazin", LUA_MODIFIER_MOTION_NONE)
...
function modifier_azazin_gayaura:OnTakeDamage (event)
    if event.unit == self:GetParent() then
        ...
        local damage_reflect_pct = (ability:GetSpecialValueFor("damage")) * 0.08 -- + self:GetCaster():FindTalentValue("special_bonus_birzha_azazin_5")) * 0.01
...
LinkLuaModifier( "modifier_azazin_agressive", "abilities/heroes/linar_josk/azazin.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_azazin_agressive_debuff", "abilities/heroes/linar_josk/azazin.lua", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier( "modifier_azazin_spinner", "abilities/heroes/linar_josk/azazin.lua", LUA_MODIFIER_MOTION_NONE )
