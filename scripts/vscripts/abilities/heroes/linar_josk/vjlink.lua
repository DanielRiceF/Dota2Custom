LinkLuaModifier( "modifier_vjlink_sputum", "abilities/heroes/linar_josk/vjlink.lua", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier( "modifier_python_active", "abilities/heroes/linar_josk/vjlink.lua", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_python_debuff", "abilities/heroes/linar_josk/vjlink.lua", LUA_MODIFIER_MOTION_NONE )
...
function Vjlink_python:GetCastRange(location, target)
    ...
    -- if self:GetCaster():HasShard() then
        -- bonus_cast_range = bonus_cast_range + 450
    -- end
...
function modifier_python_active:OnCreated( kv )
    ...
    self.speed = 1000
    self.damage = self:GetAbility():GetSpecialValueFor( "health_damage" ) / 100 -- + self:GetCaster():FindTalentValue("special_bonus_birzha_vjlink_2")) / 100
...
LinkLuaModifier( "modifier_Vjlink_teeth", "abilities/heroes/linar_josk/vjlink.lua", LUA_MODIFIER_MOTION_NONE )
...
LinkLuaModifier( "modifier_vjlink_dudos", "abilities/heroes/linar_josk/vjlink.lua", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_vjlink_dudos_effect", "abilities/heroes/linar_josk/vjlink.lua", LUA_MODIFIER_MOTION_NONE )
